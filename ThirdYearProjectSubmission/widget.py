...
'''
    ...
    NOTICE :
        ...
        Code is part of library ipywidgets

        The website contains the code of the widgets used
        This class is a class which controls the variables for each widget
        therefore the code is reused from the website but altered in this class
